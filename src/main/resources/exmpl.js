...
//
// 		var server = "/edu.chat.demoChat.janus";
//
                    ...
                    janus = new Janus(
                        {
                            ...
                            success: function () {
                                ...
                                janus.attach(
                                    {
                                        plugin: "edu.chat.demoChat.janus.plugin.audiobridge",
                                        opaqueId: opaqueId,
                                                ...
                                                if (msg["participants"] !== undefined && msg["participants"] !== null) {
                                                    ...
                                                    if (msg["error_code"] === 485) {
                                                        ...
                                                        bootbox.alert(
                                                            ...
                                                            "does not exist...</p><p>Do you have an updated <code>edu.chat.demoChat.janus.plugin.audiobridge.cfg</code> " +
